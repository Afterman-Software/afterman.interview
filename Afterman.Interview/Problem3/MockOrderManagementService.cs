...
{
    public class MockOrderManagementService : IDisposable
    {
        private readonly IBus omsBus;        

        public MockOrderManagementService()
        {
            this.omsBus = CreateOmsBus();            
        }

        private IBus CreateOmsBus()
        {
            var busConfiguration = new BusConfiguration();
            busConfiguration.EndpointName("Afterman.Orders.Server");
